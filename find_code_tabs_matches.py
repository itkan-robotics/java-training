...
def find_matches(file_path):
    """Find consecutive text/code-tabs sections with same title."""
    try:
...
def main():
    ...
    print(f"Searching {len(json_files)} files for text/code-tabs matches...\n")
    ...
    print(f"Found {total_matches} exact matches in {len(files_with_matches)} files:\n")
